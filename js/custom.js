  ...
  jQuery(document).ready(function () {
    jQuery(window).on("load", function (e) {
      ...
      jQuery(".iq-accordion .iq-accordion-block").on("click", function () {
        if (jQuery(this).children("div.iq-accordion-details").is(":hidden")) {
          jQuery(".iq-accordion .iq-accordion-block")
            ...
            .children("div.iq-accordion-details")
            .slideUp("slow");
          jQuery(this)
      ...
      $("#signup").submit(function (event) {
        ...
        var url = "http://localhost:5555/api/user/signup";
        var topost = $.post(url, {
      ...
      $("#sendiq").click(function (event) {
        ...
        var url = "http://localhost:5555/api/user/addinquiry";
        var topost = $.post(url, {
          name: $("#name").val(),
          product: $("#product").val(),
          email: $("#email").val(),
      ...
      $("#loginsubmit").click(function (event) {
        ...
        var url = "http://localhost:5555/api/user/login";
        var topost = $.post(url, {
          mobile: $("#mobile").val(),
          password: $("#password").val(),
        });
